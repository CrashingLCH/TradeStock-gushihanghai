...
function submitForm(){
	...
	<form id="registForm" action="registerServlet" method="get">
		<div class="container">
			<div class="register-box">
				...
				<div class="reg-form" id="js-form-mobile">
					...
					<div class="cell">
						<input id="name" type="text" placeholder="请输入用户名"  value="${user.name }" name="name" id="js-mail_ipt" class="text" />
					</div>
					<!-- !验证码 -->
					<div style="color:red">
						${registInfo}
					...
					<div id="vcode" class="cell vcode" style="display: none">
						<input name="inputNum" type="text" placeholder="验证码" class="text"/>
					...
					<div class="bottom" onclick="submitForm()">
						<a id="js-mobile_btn" href="javascript:;" class="button btn-blue">
						立即注册</a></div>
				</div>
